...
class SVOReader:
    ...
    def get_camera_baseline(self):
        ...
        return (
            0.001 * self._cam.get_camera_information().camera_configuration.calibration_parameters.get_camera_baseline()
        )
    ...
    def read_camera(self, ignore_data=False, correct_timestamp=None, return_timestamp=False):
        ...
        data_dict["camera_intrinsics"] = self.get_camera_intrinsics()
